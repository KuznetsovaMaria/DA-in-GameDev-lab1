...
В ходе выполнения лабораторной работы 4 я познакомилась с принципами работы перцептрона и его реализацией в unity. С помощью перцептрона произвела вычисления по логическим моделям or and nand и пробовала xor, однако на опыте убедилась в неспособности перцептрона обработать его.
